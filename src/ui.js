export default function ({ onGenerate, destinationPage }) {
    const alertWindow = COSAlertWindow.new();
    alertWindow.setMessageText('Please Confirm');
    alertWindow.setInformativeText(
        `CAUTION: This Action will delete all layers and add new swatches to the page with the name ${destinationPage}. Please be sure that you know what you're doing.`
    );
